...
const corsOrigin = isProduction
  ? [process.env.CORS_ORIGIN || "https://bbteammod.powercheats.xyz/"] // Allow configurable origin in production
...
app.use((req, res, next) => {
  ...
  if (req.path.startsWith('/api/admin/')) {
    ...
    const allowedAdminOrigin = isProduction 
      ? (process.env.CORS_ORIGIN || "https://bbteammod.powercheats.xyz/").replace(/\/$/, '')
